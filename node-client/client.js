...
const req = https.request(
  {
    host: "node-server.poc1.svc.cluster.local",
    port: 3001,
    secureProtocol: "TLSv1_2_method",
    key: fs.readFileSync(`/opt/app-root/certs/client-key.pem`),
    cert: fs.readFileSync(`/opt/app-root/certs/client-crt.pem`),
    ca: [
      fs.readFileSync(`/opt/app-root/certs/server-ca-crt.pem`)
    ],
    path: "/",
    method: "GET",
    headers: {
